...
vermin:
	@vermin --violations -t=3.4- ${VERMIN_OPTIONS} /fs1/home/ceoas/chenchon/pism/petsc-install/config
...
checkbadSource:
	...
	-@${PYTHON} /fs1/home/ceoas/chenchon/pism/petsc-install/lib/petsc/bin/maint/check_header_guard.py --action=check --kind=pragma_once -- ./src ./include >> checkbadSource.out
	-@echo "----- Double blank lines in file -----------------------------------" >> checkbadSource.out
	-@git --no-pager grep -n -P '^$$' -- ${GITSRC} > doublelinecheck.out
	-@${PYTHON} /fs1/home/ceoas/chenchon/pism/petsc-install/lib/petsc/bin/maint/doublelinecheck.py doublelinecheck.out >> checkbadSource.out
...
env-lint:
	...
	@source petsc-lint-env/bin/activate && python3 -m pip install --quiet -r lib/petsc/bin/maint/petsclinter/requirements.txt && \
          python3 /fs1/home/ceoas/chenchon/pism/petsc-install/lib/petsc/bin/maint/petsclinter --verbose=${V} --apply-patches=${REPLACE} --clang_lib=`llvm-config --libdir`/libclang.dylib --werror 1 ./src ; deactivate

#  Run a linter to check (and fix) the formatting of PETSc manual pages
lint:
	${PYTHON} /fs1/home/ceoas/chenchon/pism/petsc-install/lib/petsc/bin/maint/petsclinter --verbose=${V} --apply-patches=${REPLACE} $(LINTER_OPTIONS) ${DIRECTORY}

help-lint:
	@${PYTHON} /fs1/home/ceoas/chenchon/pism/petsc-install/lib/petsc/bin/maint/petsclinter --help
	-@echo "Basic usage:"
...
test-lint: checkvermin_exist checkmypy_exist
	vermin --config-file /fs1/home/ceoas/chenchon/pism/petsc-install/lib/petsc/bin/maint/petsclinter/pyproject.toml -- /fs1/home/ceoas/chenchon/pism/petsc-install/lib/petsc/bin/maint/petsclinter
	if [[ "$(LINTER_SKIP_MYPY)" == "0" ]]; then \
          cd /fs1/home/ceoas/chenchon/pism/petsc-install/lib/petsc/bin/maint/petsclinter && mypy . ; \
        fi
	${PYTHON} /fs1/home/ceoas/chenchon/pism/petsc-install/lib/petsc/bin/maint/petsclinter/petsclinter/pkg_consistency_checks.py
	${PYTHON} /fs1/home/ceoas/chenchon/pism/petsc-install/lib/petsc/bin/maint/petsclinter /fs1/home/ceoas/chenchon/pism/petsc-install/src/sys/tests/linter --test -j0 --werror --replace=${REPLACE} --verbose=${V} $(LINTER_OPTIONS)
